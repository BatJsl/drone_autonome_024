...
class InspectionDroneVirtual(object):
    ...
    def __init__(self, connection_string, baudrate, two_way_switches, three_way_switches,
        ...
        - lidar_vertical_address: list of I2C addresses of vertical lidars
        - lidar_vertical_position: list of positions of vertical lidars, 1 if lidar is up, 0 is lifar is down
        ...
        self.vertical_lidars = VerticalLidarsDetection(lidar_vertical_address, lidar_vertical_position)
    ...
    # Definition of update vertical functions GMM024

    def update_vertical_detection(self):
        self.vertical_lidars.update_vertical_path()

    def do_vertical_up_reading(self):
        return self.vertical_lidars.get_up_lidar().lidar_reading()

    def do_vertical_down_reading(self):
        return self.vertical_lidars.get_down_lidar().lidar_reading()
    ...
    def send_mavlink_go_up(self, velocity):
        """
